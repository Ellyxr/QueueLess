...
export class UsersController {
  ...
  @Patch('me/data-access-consent')
  updateDataAccessConsent(
    @Req() request: AuthenticatedRequest,
    @Body() dto: UpdateDataAccessConsentDto,
  ) {
    return this.usersService.updateDataAccessConsent(
      request.user.sub,
      dto.granted,
    );
  }

// Placeholder data for parts of the admin panel not yet wired to a real
// backend — see AddressMe.md in artifacts/api-server for what's missing.
// Users are wired to real data; see AdminUserRow/listAdminUsers in features/auth/api.ts.
